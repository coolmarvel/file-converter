...
type Tab = 'levels' | 'curves' | 'exposure' | 'hsl' | 'effects'
...
/** 스포이트 표본 — 선택 파일 축소본을 보여 주고 클릭한 곳의 색을 돌려준다 */
...
export default function AdjustDialog({
  ...
  return (
    ...
    >
      <ClassicTabs value={tab} onChange={setTab} tabs={TABS} />
