 ...
 * 변환기에서의 주된 쓰임은 **스티커**(AI 배경 제거 → 흰 외곽선 + 그림자) — 프리셋 버튼 하나로.
 */
  ...
  return (
    ...
    >
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
        ...
        <Box sx={{ fontSize: font.xs, color: color.textSecondary }}>흰 외곽선 10px + 옅은 그림자 — AI 배경 제거와 함께 쓰세요. 투명 배경(PNG·WebP)에서 모양을 따라갑니다.</Box>
      </Box>
      <ClassicTabs
        value={tab}
        onChange={setTab}
